<section id="contact-target" class="flex justify-center py-16 text-center bg-pink-50/50 m-auto max-w-screen min-w-0">
    <div class="max-w-[1000px]">
        ...
        <div class="grid gap-y-4 grid-cols-1 md:grap-y-0 md:gap-x-4 md:grid-cols-2">
            <div class="transition flex flex-col justify-center items-center w-64 p-4 bg-green-50 rounded-lg hover:bg-green-100 hover:cursor-pointer">
                <a href="https://wa.me/4915739663432">
                    <div class="flex justify-center items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#22c55e" fill="none">
            ...
            <div class="transition flex flex-col justify-center items-center w-64 p-4 bg-blue-50 rounded-lg hover:bg-blue-100 hover:cursor-pointer">
                <a href="mailto:raven@horse-time.de">
                    <div class="flex justify-center items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#3b82f6" fill="none">
